...
<ul>
 ...
 @endif
              <form method="POST" action="{{route('managerrooms.updatemanager', ['room' => $room['id']])}}">
              @csrf
              @method('PUT')
                <div class="card-body">
                <div class="form-group">
                    <label for="number">Number</label>
                    <input type="text" class="form-control" id="number" placeholder="Enter room number" value="{{$room['number']}}" name="number">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputCapacity">Capacity</label>
                    <input type="text" class="form-control" id="exampleInputCapacity" placeholder="capacity" value="{{$room['capacity']}}" name="capacity">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputPrice">Price ($)</label>
                    <input type="text" class="form-control" id="exampleInputText" placeholder="Enter rice in dollars" value="{{$room['price']}}" name="price">
                  </div>
                  <table>
                  <tr>
                  <div class="form-group">
                    <label for="exampleInputFloor">Floor Number</label>
