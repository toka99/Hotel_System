 ...
 <aside class="main-sidebar sidebar-dark-primary elevation-4">
  ...
  <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Create Room Form</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <div class="container">
...
<ul>
 ...
 @endif
              <form method="POST" action="{{route('managerrooms.storemanager')}}">
              @csrf
                <div class="card-body">
                <div class="form-group">
                    <label for="number">Number</label>
                    <input type="text" class="form-control" id="number" placeholder="Enter room number" name="number">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputCapaicty">capacity</label>
                    <input type="text" class="form-control" id="capacity" placeholder="Enter capacity of the room" name="capacity">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputPrice">price ($)</label>
                    <input type="text" class="form-control" id="exampleInputCapacity" placeholder="Enter price in dollars" name="price">
                  </div>
