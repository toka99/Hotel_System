...
<head>
  ...
  <title>Manager| Create Client</title>
...
<div class="wrapper">
  ...
  <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Create Client Form</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <div class="container">
...
<ul>
 ...
 @endif
              <form method="POST" action="{{route('managerapproveclients.storemanager')}}">
              @csrf
                <div class="card-body">
                <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleInputGender1" placeholder="Gender" name="country">
                  </div>
