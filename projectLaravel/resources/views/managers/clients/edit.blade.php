...
<head>
  ...
  <title>Manager|Edit  Clients</title>
...
<ul>
 ...
 @endif
              <form method="POST" action="{{route('managerapproveclients.updatemanager', ['client' => $client['id']])}}">
              @csrf
              @method('PUT')
                <div class="card-body">
                <div class="form-group">
                    <label for="name">Name</label>
                    <input type="text" class="form-control" id="name" placeholder="Enter name" value="{{$client['name']}}" name="name">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Email address</label>
                    <input type="email" class="form-control" id="exampleInputEmail1" placeholder="Enter email" value="{{$client['email']}}" name="email">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputFile">Choose an image</label>
                    <div class="input-group">
                      <div class="custom-file">
                        <input type="file" class="custom-file-input" id="exampleInputFile" value="{{$client['image']}}" name="image">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleInputGender1" placeholder="Gender" value="{{$client['gender']}}" name="gender">
                  </div>
   
                  <div class="form-group">
                    <label for="country">Country</label>
                    <input type="text" class="form-control" id="country" placeholder="enter country" value="{{$client['country']}}" name="country">
                  </div>
