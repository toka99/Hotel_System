...
<head>
  ...
  <title>Manager|Approved Clients </title>
      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            ...
            <a href="{{route('managerapproveclients.createmanager')}}"  type="button" class="btn btn-primary btn-sm">
...
<script type="text/javascript">
  ...
  $(function () {
    ...
    var table = $('.yajra-datatable').DataTable({
        ...
        processing: true,
        serverSide: true,
        ajax: "{{ route('managerapproveclients.list') }}",
        columns: [
