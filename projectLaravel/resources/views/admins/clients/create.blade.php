...
<head>
  ...
  <title>Admin| Create Client</title>
...
<ul>
 ...
 @endif
              <form method="POST" action="{{route('adminapproveclients.store')}}">
              @csrf
                <div class="card-body">
                <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleInputGender1" placeholder="country" name="country">
                  </div>
